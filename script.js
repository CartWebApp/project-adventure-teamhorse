...
const leaveOutpostChad = new storyPart(`9ad`, [``, `You reunite with the knights and rest for the night.`, `After morning comes Chad pulls you aside.`, `Chad von Chad: “Take this, it is a sword of the highest quality.”`, `Chad von Chad:  “Once we continue the monsters will only get stronger and you will need it if you wish to survive.”`], [{name: "Leave Outpost", effect: ()=> moveTo(ruinedTownChad)}])
...
const wastelandFightOwainWin = new storyPart(`8ba`, [``,`You Won`, `Owain: “We did well. I believe we can move faster if we are this strong.”`, `You and Owain continue onward with newfound confidence`], [{name: "Continue deeper into the wastelands", effect: ()=> moveTo(outpostOwain),}])
const wastelandFightOwainLose = new storyPart(`8bb`, [``,`You Lost`, `Owain: “Darnit! I didn't want to have to use this so soon”`, `Owain pulled out a small palm sized ball from his bag and began to inscribe runes onto it.`, `When he finished his inscriptions he threw the ball at the monster before the small item suddenly burst into a thick cloud of smoke.`, `Owain: "RUN NOW!"`, `As you and Owain run away defeated Kameron follows you from behind.`, `Kameron (whispering): “Hmm.. should we have trained for longer?”`], [{name: "Continue deeper into the wastelands", effect: ()=> moveTo(outpostOwain),}])
