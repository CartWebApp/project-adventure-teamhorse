...
const fishing = new storyPart(`1aa`,[``,`You pull out your long rod, line,  and prepare bait.`],[{name: `Cast your Rod`, effect: () => {document.getElementById(`textDisplay`).textContent = ``; fish()}},{name: `Leave the River`, effect: () => {moveTo(secondLeft); document.getElementById(`option#0`).style.opacity = 1; document.getElementById(`option#0`).style.zIndex = `auto`; }}]);
