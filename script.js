...
const ripKameronChad = new storyPart(`14a`,[``,`After being given some time to grieve Chad urges you to continue.`,`Chad von Chad: “I know your pain, but the end is near. Let's finish this.”`, `Chad von Chad: “For Kameron.”`],[{name: `Continue`, effect: () => moveTo()}]);
const inTheTowerChad = new storyPart(``,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
...
const stoneTabletOwain = new storyPart(`10b`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const stoneTabletFightWin = new storyPart(`10ba`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const stoneTabletFightLose = new storyPart(`10bb`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const owainTranslateTablet = new storyPart(`11b`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const questionJourneyOwain = new storyPart(`11ba`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const questionJourney1Owain = new storyPart(`11bb`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const questionJourney2Owain = new storyPart(`11bc`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const questionJourney3Owain = new storyPart(`11bd`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const questionJourney4Owain = new storyPart(`11be`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const questionJourney5Owain = new storyPart(`11bf`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const runAwayEndingOwain = new storyPart(`E3b`,[``,`As you continue to question the journey ahead you realize that risking your life for a horse past its prime is not really worth it.`,`You gather your things and prepare to sneak out in the middle of the night.`, `Once Owain and Kameron have fallen asleep you leave them behind and head back to town.`, `A week passes and you finally arrive at town feeling refreshed.`, `You spend the rest of your days in the town and marry a beautiful woman and have three children.`, `THE END`],[{name: `Restart Game`, effect: () => {player.inventory.egg = 10; reset();}},{name: `Go back`, effect: () => moveTo(questionJourneyOwain)}]);
...
const towerEntranceOwain = new storyPart(`12b`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const afterBeastFightOwain = new storyPart(`13b`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
const inTheTowerOwain = new storyPart(`14a`,[``,``,``],[{name: `choice2`, effect: () => moveTo()},{name: `choice1`, effect: () => moveTo()}]);
