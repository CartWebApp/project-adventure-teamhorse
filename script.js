...
const questionJourney4Owain = new storyPart(`11ae`,[``,`You: ‘Even if I couldn’t find Korai at the end of the day he’s just a horse.’`],[{name: `Question it even more`, effect: () => moveTo(questionJourney5Owain)},{name: `Ignore your doubts`, effect: () => moveTo(restBeforeTowerOwain)}]);
