...
const finalBoss = new monster(`Sgriobhadair`,8,2,`A`,`D`,`W`)
const trueFinalBoss = new monster(`The True Sgriobhadair`,10,3,`A`,`D`,`W`)
...
const trueBoss = new fight(``,trueFinalBoss,player.companion);
