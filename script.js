...
const bossEndOwain = new storyPart(`E7b`, [``,`2 years later.`,`You joined Owain and made it rich as a detective pair.`, `Hailed as heroes, you enjoy a booming business.`, `You enjoy the rest of your life as a hero and respected detective along with Owain.`, `THE END`], [{name: `Restart Game`, effect: ()=> reset()}])
const bossLoseOwain = new storyPart(`E8b`,[``,`You lose to Sgriobhadair and are helpless as Sgriobhadair goes to annihilate the distracted Owain`,`You can only hear screams and the crushing of bones as Sgriobhadair battles Owain.`, `Sgriobhadair returns to you and looks at you with pity.`, `Sgriobhadair: “You were strong, but what is your strength compared to mine?”`, `Sgriobhadair orders his monsters to finish you and the last thing you see is his twisted smile.`],[{name: `Restart Game`, effect: ()=> reset()}, {name: `Return to doors`, effect: () => moveTo(bossDoorsOwain)}]);
